...
const CreateRequestModal = ({ visible, onHide }) => {
    ...
    return (
        <div>
            <Dialog header="Create Request" visible={visible} onHide={onHide} style={{ width: '40vw' }} className='create__request__header'>
                <div className='create__request__modal'>
                    <div className="grid">
                        <div className="col-6">
                            ...
                            <div className='mt-2'>
                                <Dropdown value={requestType} onChange={(e) => setRequestType(e.value)} options={groupedCities}
                        ...
                        <>
                            ...
                            <div className="grid mt-1">
                                <div className="col-6">
                                    ...
                                    <div className='mt-2'>
                                        <InputText value={time} onChange={(e) => setTime(e.target.value)} placeholder='Enter' className='start__time' />
                                    </div>
                                </div>
                                <div className="col-6">
                                    <div className='request__type__text'>End Time<span className='required__field'>*</span></div>
                                    <div className='mt-2'>
                                        <InputText value={endTime} onChange={(e) => setEndTime(e.target.value)} placeholder='Enter' className='start__time' />
                                    </div>
                                </div>
                            </div>
                        </>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end' }} className='mt-3'>
                    ...
                    <Button label="Submit" onClick={show} className='submit__button' />
                </div>
            </Dialog>
        </div>
    );
